    ...
    <main className="mx-auto flex max-w-3xl flex-col gap-6 p-4 sm:p-6">
      <div className="flex flex-wrap items-end justify-between gap-3">
        <div>
          ...
          <div className="mt-2 h-3.5 w-56 animate-pulse rounded bg-neutral-200" aria-hidden="true" />
        </div>
        <div className="h-10 w-28 animate-pulse rounded-full bg-neutral-200" aria-hidden="true" />
      </div>
      ...
      <div className="animate-pulse space-y-6" aria-hidden="true">
        ...
        {/* HopeBanner (SPEC 9절) */}
        <div className="h-16 rounded-2xl bg-neutral-200/70" />
